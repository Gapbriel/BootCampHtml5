...
<html lang="en">
    <head>
       ...
       <script src="scripts/require.js" type="text/javascript" language="JavaScript"></script>
     <script src="../../1/jquery-1.7.js" type="text/javascript" language="JavaScript"></script>
